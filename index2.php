...
<div class="accordion accordion-flush" id="accordionFlushExample">
    <div class="accordion-item border-0">
        <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed bg-black text-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                <img class="icono" src="casita.blanca.webp">
                Bienvenidos
            </button>
        </h2>
        <div id="flush-collapseOne" class="accordion-collapse collapse min-vh-100 bg-black text-white" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
    ...
    <div class="accordion-item border-0">
        ...
        <div id="flush-collapseTwo" class="accordion-collapse collapse min-vh-100 bg-black text-white" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
